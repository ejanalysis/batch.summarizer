  ...
  fluidPage(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        h5(' "traffic.score","pctpre1960","pm","o3","cancer","dpm","resp","neuro","proximity.tsdf","proximity.rmp","proximity.npl","proximity.npdes", '),
        h5(' "VSI.eo","VSI.svi6", '),
        h5(' "inedx_EJ_Traffic","inedx_EJ_Lead","inedx_EJ_PM","inedx_EJ_Ozone","inedx_EJ_Cancer","inedx_EJ_DPM","inedx_EJ_Resp","inedx_EJ_Neuro","inedx_EJ_proximity.tsdf","inedx_EJ_proximity.rmp","inedx_EJ_proximity.npl","inedx_EJ_proximity.npdes", '),
        h5(' "BLOCKID","Distance.x",    # *****??????? '),
        h5(' "BLOCKGROUPFIPS","STUSAB","STATE","COUNTY","TRACT","BLKGRP","BLOCK","REGION", '), 
        h5(' "N_D_INDEX_PER", '), 
        h5(' "N_E_NPDES_PER","N_E_TSDF_PER","N_E_RMP_PER","N_E_NPL_PER","N_E_LEAD_PER","N_E_TRAFFIC_PER","N_E_RESP_PER","N_E_NEURO_PER","N_E_CANCER_PER","N_E_DIESEL_PER","N_E_O3_PER","N_E_PM25_PER", '), 
        h5(' "N_D_MINOR_PER","N_D_INCOME_PER","N_D_LESSHS_PER","N_D_LING_PER","N_D_UNDER5_PER","N_D_OVER64_PER", '), 
        h5(' "N_D_INDEX", '), 
        h5(' "N_E_NPDES","N_E_TSDF","N_E_RMP","N_E_NPL","N_E_LEAD","N_E_TRAFFIC","N_E_RESP","N_E_NEURO","N_E_CANCER","N_E_DIESEL","N_E_O3","N_E_PM25", '), 
        h5(' "N_D_MINOR","N_D_INCOME","N_D_LESSHS","N_D_LING","N_D_UNDER5","N_D_OVER64", '), 
        h5(' "R_D_INDEX_PER", '), 
        h5(' "R_E_NPDES_PER","R_E_TSDF_PER","R_E_RMP_PER","R_E_NPL_PER","R_E_LEAD_PER","R_E_TRAFFIC_PER","R_E_RESP_PER","R_E_NEURO_PER","R_E_CANCER_PER","R_E_DIESEL_PER","R_E_O3_PER","R_E_PM25_PER", '), 
        h5(' "R_D_MINOR_PER","R_D_INCOME_PER","R_D_LESSHS_PER","R_D_LING_PER","R_D_UNDER5_PER","R_D_OVER64_PER", '), 
        h5(' "R_D_INDEX", '), 
        h5(' "R_E_NPDES","R_E_TSDF","R_E_RMP","R_E_NPL","R_E_LEAD","R_E_TRAFFIC","R_E_RESP","R_E_NEURO","R_E_CANCER","R_E_DIESEL","R_E_O3","R_E_PM25", '), 
        h5(' "R_D_MINOR","R_D_INCOME","R_D_LESSHS","R_D_LING","R_D_UNDER5","R_D_OVER64", '), 
        h5(' "S_D_INDEX_PER", '), 
        h5(' "S_E_NPDES_PER","S_E_TSDF_PER","S_E_RMP_PER","S_E_NPL_PER","S_E_LEAD_PER","S_E_TRAFFIC_PER","S_E_RESP_PER","S_E_NEURO_PER","S_E_CANCER_PER","S_E_DIESEL_PER","S_E_O3_PER","S_E_PM25_PER", '), 
        h5(' "S_D_MINOR_PER","S_D_INCOME_PER","S_D_LESSHS_PER","S_D_LING_PER","S_D_UNDER5_PER","S_D_OVER64_PER", '), 
        h5(' "S_D_INDEX", '), 
        h5(' "S_E_NPDES","S_E_TSDF","S_E_RMP","S_E_NPL","S_E_LEAD","S_E_TRAFFIC","S_E_RESP","S_E_NEURO","S_E_CANCER","S_E_DIESEL","S_E_O3","S_E_PM25", '), 
