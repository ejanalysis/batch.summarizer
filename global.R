...
# ***  SPECIFY LARGE FILE THAT IS OUTPUT OF BATCH RUN AND INPUT TO THIS SUMMARIZER: ***
#
# Must do so here if huge file too large for Shiny's file upload limit - 
...
#
# To specify a local large custom file, can uncomment the following line
# 
...
# Some or all of these maps between versions of field names could be handled using the 
# ejscreen package now, via data('ejscreenformulas'), with e.g., 
# gdbfieldname      "CANCER"                
# Rfieldname        "cancer"                
# acsfieldname      NA                      
...
print('MUST UPDATE ACS DATA IN CODE WHEN SWITCHING TO NEW ACS DATASET!')
